  ...
  function armarCasos() {
    ...
    leer('campanas').forEach(function (c) {
      ...
      (c.cultivos || []).forEach(function (cu, i) {
        ...
        casos.push({
          ...
          rotacion: window.SafiaInsumos ? SafiaInsumos.rotacion(cu.cultivo, cu.cultivoAnterior, cu.cobertura) : null,
    ...
    leer('ciclos').forEach(function (ci) {
      ...
      casos.push({
        ...
        rotacion: window.SafiaInsumos ? SafiaInsumos.rotacion(ci.cultivo, ci.cultivoAnterior, ci.cobertura) : null,
